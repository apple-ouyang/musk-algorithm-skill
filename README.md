...
A public research corpus and reusable agent skill built around Elon Musk's five-step working method, commonly known as "The Algorithm."
...
This repository is intentionally scoped to provide:

- **Primary and secondary public sources** relevant to the five-step method
- **Normalized Markdown copies** of those sources for easy reference
- **A reusable agent skill** built from the corpus, ready to apply the method to your own work
- **Lightweight evals and helper scripts** to validate and maintain the skill

This is not an attempt to mirror every public article ever written about Elon Musk. The focus is narrow: the five-step method, its context, and its practical application.
...
- `docs/` — design notes, assumptions, and progress documentation

## Referenced Articles

Each article below is included for a specific reason. These are the sources that best support the five-step method and its real-world context.
